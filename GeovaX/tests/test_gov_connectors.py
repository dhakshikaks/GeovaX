...
from GeovaX.ingest.naksha import NakshaConnector, TN_FEATURE_SERVERS
from GeovaX.ingest.soi_cors import SOICorsConnector
from GeovaX.ingest.tn_revenue import TNRevenueConnector
...
def test_tn_revenue_never_matches_a_different_survey_number(monkeypatch):
    ...
    import GeovaX.ingest.tn_revenue as tn_revenue_mod
