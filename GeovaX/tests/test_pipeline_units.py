...
from GeovaX.attributes.schema_match import SchemaMatcher, profile_column
from GeovaX.attributes.translit import canonical_place, detect_script, normalise_name, transliterate
from GeovaX.change.vector_change import ChangeConfig, ChangeDetector
from GeovaX.confidence.scorer import ConfidenceScorer
from GeovaX.conflict.evidence import MassFunction, combine, combine_all, fuse
from GeovaX.core.models import (Cardinality, ChangeType, Claim, Evidence, MatchPair,
                                  SourceDataset, SourceType)
from GeovaX.core.registry import AUTHORITIES, SourceRegistry
from GeovaX.crs.gcp import GroundControlPoint, GeoReferencer, choose_model
from GeovaX.geoai.footprints import ExtractionQC, RegulariseConfig, rectilinearity, regularise
from GeovaX.matching.assign import AssignmentConfig, GlobalAssigner
from GeovaX.matching.features import (BlockingConfig, CandidateGenerator, FeatureExtractor,
                                        MatchableFeature)
from GeovaX.matching.normalise import normalise_survey_number, normalise_zone, parse_survey_number
from GeovaX.raster.terrain import GroundFilterConfig, dsm_to_dtm, extract_structures, normalised_dsm
from GeovaX.raster.coreg import coregister, shift_image
from GeovaX.topology.repair import RepairConfig, TopologyRepairer
from GeovaX.topology.validate import RuleId, Severity, TopologyValidator, validate_network
...
def test_phase_correlation_recovers_a_known_shift():
    ...
    from GeovaX.raster.coreg import normalised_cross_correlation
