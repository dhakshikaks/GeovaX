...
from GeovaX.core.models import FeatureClass, SourceDataset, SourceType
from GeovaX.core.registry import AUTHORITIES
from GeovaX.ingest.vector import GeoJsonLinesConnector
from GeovaX.matching.features import BlockingConfig, MatchableFeature
from GeovaX.matching.pipeline import MatchingPipeline
from GeovaX.attributes.schema_match import SchemaMatcher
...
def test_two_cadastral_compilations_disagree_as_expected():
    ...
    from GeovaX.ingest.vector import GeoJsonLinesConnector as C
