...
def test_parcel_timeline_reports_source_observations_and_pipeline_stages():
    ...
    ledger.append("TNGIS_CADASTRE", "ingest", {"features": 30689}, actor="geovax/auto")
    ledger.append("TNGIS_CADASTRE", "schema_map", {"columns": 12}, actor="geovax/auto")
