...
_ENV_SECRET_VAR = "GEOVAX_JWT_SECRET"
...
def _load_signing_secret() -> str:
    ...
    multi-process or production deployment. Set ``GEOVAX_JWT_SECRET`` explicitly there.
    """
...
def sign_token(claims: dict[str, Any], *, ttl_seconds: int = _TOKEN_TTL_SECONDS) -> str:
    ...
    header_b64 = _b64url_encode(json.dumps({"alg": "HS256", "typ": "GEOVAX-JWT"}).encode())
