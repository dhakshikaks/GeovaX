"""Command-line entry point.
    ...
    geovax run       --aoi mid --out out/chennai
    geovax serve     --out out/chennai_metro
    geovax verify    --out out/chennai_metro
    geovax describe  EPSG:24383
"""
...
def main() -> int:
    ap = argparse.ArgumentParser(prog="geovax", description=__doc__,
