-- GeovaX canonical spatial schema (PostgreSQL 16 + PostGIS 3.4)
--
...
CREATE SCHEMA IF NOT EXISTS geovax;
SET search_path TO geovax, public;
...
CREATE TABLE IF NOT EXISTS resolution (
    ...
    resolved_by     text NOT NULL DEFAULT 'geovax/auto',
