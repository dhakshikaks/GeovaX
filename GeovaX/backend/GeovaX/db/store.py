...
def get_engine():
    ...
    try:
        ...
        # schema.sql creates everything in the `geovax` schema and only sets search_path
        ...
        engine = create_engine(
            ...
            connect_args={"connect_timeout": 3, "options": "-c search_path=geovax,public"},
        )
...
def _write_pipeline_run(conn, text, *, run_id: str, aoi_name: str,
    ...
    """), {
        ...
        "ledger_root": ledger.merkle_root(), "software_version": "geovax/1.0.0",
    })
