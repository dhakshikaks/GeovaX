...
sys.path.insert(0, "/home/claude/GeovaX/backend")
from shapely.geometry import shape
from shapely.ops import transform as T
from pyproj import Transformer

from GeovaX.matching.features import MatchableFeature, BlockingConfig
...
t0 = time.time()
A = load("/home/claude/GeovaX/data/aoi/buildings_gcc.geojsonl", "gcc")
print("A", len(A), round(time.time() - t0, 1), flush=True)
B = load("/home/claude/GeovaX/data/aoi/buildings_gob.geojsonl", "gob")
