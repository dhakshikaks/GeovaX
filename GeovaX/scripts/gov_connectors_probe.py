...
from GeovaX.ingest.naksha import NakshaConnector  # noqa: E402
from GeovaX.ingest.soi_cors import SOICorsConnector  # noqa: E402
from GeovaX.ingest.tn_revenue import TNRevenueConnector  # noqa: E402
...
def main() -> None:
    ...
    report["systems"]["njdg_ecourts"] = {
        "note": "services.ecourts.gov.in's public search requires a CAPTCHA for every query "
                ...
                "mechanism (see backend/GeovaX/analytics/litigation.py).",
    }
