#!/usr/bin/env python3
"""Run the full GeovaX harmonisation over the real Chennai corpus.
...
from GeovaX.pipeline.harmonise import HarmoniseConfig, HarmonisationPipeline  # noqa: E402
from GeovaX.pipeline.presets import AOIS, default_layers as layers  # noqa: E402
...
def main() -> int:
    ...
    print(f"GeovaX — {name} {bbox}", flush=True)
    out = pipe.run()
