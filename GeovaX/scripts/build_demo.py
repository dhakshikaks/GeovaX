...
inlines it into a single HTML file that opens by double-clicking.
    ...
    python scripts/build_demo.py --out out/chennai --dest demo/geovax-demo.html
"""
...
def main() -> int:
    ...
    ap.add_argument("--dest", default="demo/geovax-demo.html")
    ...
    html = html.replace("/*__GEOVAX_DATA__*/null", blob)
